...
export const article = {
  author: {
    ...
    link: 'https://app.publed.io/profile/1',
  },
  date: '2024-04-04',
  title: "When Science & Education meet Web3",
  tags: ['Web3', 'DeSci'],
  description:
    'Democratizing & Socializing Knowledge',
  imgPreview: '/assets/blog/science-education/science-education.png',
  readingTime: '5 min',
}
...
export default (props) => <ArticleLayout article={article} metadata={metadata} {...props} />
