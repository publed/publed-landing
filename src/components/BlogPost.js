...
const BlogPost = ({ fileName }) => {
  ...
  const MarkdownComponents = {
    ...
    ol: ({ children }) => <ol className="list-decimal list-inside pl-6">{children}</ol>,
    li: ({ children }) => (
    ...
    img: ({ src, alt }) => {
      ...
      return <img src={src} alt={alt} className="rounded-lg overflow-hidden my-12 w-full" />;
    },
    p: ({ children }) => {
      return (
        <p className="mb-4">
  ...
  return (
    <div className="my-20 mx-auto flex flex-col items-center">
      <div className="max-w-screen-lg flex flex-col items-center">
        ...
        <h1  className="font-semibold text-dark-blue-60 text-5xl text-center mb-2 mt-12 ">{post.title}</h1>
        ...
        />
        <div 
          className="prose prose-invert md:prose-xl prose-code:break-words prose-pre:bg-gray-900 prose-pre:leading-relaxed md:prose-code:break-normal text-dark-blue-60 "
        >
