...
const PagesNavbar = () => {
  ...
  return (
    <nav className="w-full flex flex-col py-4 px-5 sm:px-10 items-center fixed bg-[#052241] backdrop-blur-[6px]">
      <div className="w-full flex flex-row items-center justify-between">
        <img src={hlogo} alt="publed" className="w-[130px] sm:h-[36px]" />
        <div className="flex flex-row space-x-4">
          ...
          <button className="px-9 py-3 rounded-full button-main text-typo-dark-blue">
            Sign In
          </button>
